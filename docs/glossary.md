...
| **The desk** | The web page (`gatekeeper ui`) where a person approves or denies held writes, reads the activity, runs the integrity check, and sees the governed servers |
