...
- **`runbooks/`** — operator runbooks (M3.5: [connector onboarding](runbooks/connector-onboarding.md)
  — govern a credentialed third-party MCP server with config + `.env` only).
